 ...
 */
@property (nonatomic, assign) SBChartViewState state;
 ...
 * Used as a selection ivew in SBChartView subclasses.
 */
@interface SBChartSelectionView : UIView
