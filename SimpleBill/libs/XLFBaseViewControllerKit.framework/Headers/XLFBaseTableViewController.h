...
@property(strong, nonatomic) UIImage   *evBackgroundImage;//默认背景图片,注意使用该方法，整个App的背景将会都将会被改变
@property(strong, nonatomic) UIImage   *evNavBackgroundImage;//默认导航背景图片,注意使用该方法，整个App的背景将会都将会被改变
