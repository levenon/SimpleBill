...
enum XLFTextAlignment {
    
    XLFTextAlignmentTop = 0,
    XLFTextAlignmentCenter 
};
...
@interface XLFSegmentedItem : NSObject
...
@property (nonatomic, strong) IBOutletCollection(XLFSegmentedItem) NSArray *items;
...
@property (nonatomic, assign) enum XLFTextAlignment singleLineTextAlignment; // Default is NSTextAlignmentCenter
...
- (void)setItem:(XLFSegmentedItem*)item atIndex:(NSInteger)nIndex;
